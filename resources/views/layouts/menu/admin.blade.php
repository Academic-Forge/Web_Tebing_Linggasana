<nav class="space-y-1 px-3">
    ...
    <!-- Kuota Kunjungan -->
    <a href="#" 
       class="flex items-center gap-3.5 px-4 py-3 rounded-2xl text-sm font-semibold text-slate-400 hover:bg-slate-800/40 hover:text-slate-200 transition-all duration-200">
        <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
